$(document).ready(function() {
  ...
  var test_gear = new Gear_piece("Tactical Holster", 3, 209, 303, 300, 404, ["TalentName"], [{"name": "Prototype Stamina Mod", "type": "stamina", "val": 100}]);
  var test_gear_2 = new Gear_piece("Chest Plate", 4, 409, 0, 300, 0, ["TalentName_1"], [{"name": "Prototype Stamina Mod", "type": "stamina", "val": 100}]);
  ...
  var generate_gear_tooltip = function(piece) {
    ...
    if(piece.firearms > 0){a.push("<b>FIREARMS:</b> "+t_f);}
    if(piece.firearms > 0){a.push("<b>STAMINA:</b> "+t_s);}
    if(piece.firearms > 0){a.push("<b>ELECTRONICS:</b> "+t_e);}
  ...
  if (QueryString.uid) {
    ...
    $("#agent-name").text(agent_un);
    $("#sharelink").val("http://darkzone.nightbug.se/agent/?uid=" + encodeURIComponent(QueryString.uid));
